...
<div class="enhanced-card fade-in">
  <div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
      ...
      <button onclick="openAddModal()" class="btn-premium text-white px-6 py-3 rounded-xl font-semibold flex items-center gap-2">
    ...
    <div class="search-filter-container">
      <div class="search-box">
        <input type="text" id="searchInput" placeholder="Search by name or phone number..." 
               class="form-input" onkeyup="filterEmployees()">
      </div>
    ...
    <form id="addEmployeeForm" enctype="multipart/form-data">
      <div class="grid-2">
        <div class="form-group">
          ...
          <div class="autocomplete-container">
            <input type="text" id="employeeName" name="name" class="form-input" required placeholder="Start typing candidate name or click to see all..." oninput="handleNameInput(this.value)" onfocus="handleNameFocus()">
      ...
      <div class="grid-2">
        ...
        <div class="form-group">
          ...
          <input type="text" name="nic_number" id="nic_number" class="form-input" placeholder="National Identity Card Number">
        </div>
      </div>
      ...
      <!-- CV Info Display -->
      <div id="cvInfoBox" class="form-group hidden" style="display: none; background: #e0f7fa; border-left: 4px solid #0ea5a9; padding: 1rem; border-radius: 8px; margin-top: 1rem;">
      ...
      <div class="grid-2">
        <div class="form-group">
          ...
          <div class="file-input-wrapper">
            <input type="file" name="national_id" id="national_id" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          ...
          <div class="file-input-wrapper">
            <input type="file" name="character_certificate" id="character_certificate" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          ...
          <div class="file-input-wrapper">
            <input type="file" name="bank_proof" id="bank_proof" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          ...
          <div class="file-input-wrapper">
            <input type="file" name="appointment_letter" id="appointment_letter" accept=".pdf,.doc,.docx" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          ...
          <div class="file-input-wrapper">
            <input type="file" name="photograph" id="photograph" accept=".jpg,.jpeg,.png" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          ...
          <div class="file-input-wrapper">
            <input type="file" name="ol_result" id="ol_result" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          ...
          <div class="file-input-wrapper">
            <input type="file" name="al_result" id="al_result" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this)">
  ...
  <div class="modal-content">
    ...
    <form id="editEmployeeForm" enctype="multipart/form-data">
      ...
      <div class="grid-2">
        ...
        <div class="form-group">
          <label class="form-label">NIC Number</label>
          <input type="text" name="nic_number" id="edit_nic_number" class="form-input" placeholder="National Identity Card Number">
        </div>
      </div>
      
      <div class="form-group">
        <label class="form-label">Verified By</label>
        <input type="text" name="verified_by" id="edit_verified_by" class="form-input" placeholder="Name of verifying officer">
      </div>
      
      <h3 class="text-lg font-semibold mb-4 mt-6 text-gray-800 dark:text-gray-100">Documents (Upload new to replace)</h3>
      
      <div class="grid-2">
        <div class="form-group">
          <label class="form-label">National ID</label>
          <div class="file-input-wrapper">
            <input type="file" name="national_id" id="edit_national_id" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          <label class="form-label">Character Certificate</label>
          <div class="file-input-wrapper">
            <input type="file" name="character_certificate" id="edit_character_certificate" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          <label class="form-label">Bank Account Proof</label>
          <div class="file-input-wrapper">
            <input type="file" name="bank_proof" id="edit_bank_proof" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          <label class="form-label">CV / Resume</label>
          <div class="file-input-wrapper">
            <input type="file" name="cv_resume" id="edit_cv_resume" accept=".pdf,.doc,.docx" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          <label class="form-label">Appointment Letter</label>
          <div class="file-input-wrapper">
            <input type="file" name="appointment_letter" id="edit_appointment_letter" accept=".pdf,.doc,.docx" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          <label class="form-label">Employee Photograph</label>
          <div class="file-input-wrapper">
            <input type="file" name="photograph" id="edit_photograph" accept=".jpg,.jpeg,.png" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          <label class="form-label">OL Result Sheet</label>
          <div class="file-input-wrapper">
            <input type="file" name="ol_result" id="edit_ol_result" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this)">
        ...
        <div class="form-group">
          <label class="form-label">AL Result Sheet</label>
          <div class="file-input-wrapper">
            <input type="file" name="al_result" id="edit_al_result" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this)">
      ...
      <div class="flex gap-3 mt-6">
        <button type="button" onclick="closeEditModal()" class="flex-1 py-3 rounded-xl border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors font-semibold">
          Cancel
        </button>
        <button type="submit" class="flex-1 btn-premium text-white py-3 rounded-xl font-semibold">
...
<div id="viewModal" class="modal">
  <div class="modal-content">
    ...
    <div class="mt-6">
      <button onclick="closeViewModal()" class="w-full py-3 rounded-xl border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors font-semibold">
        Close
      </button>
    </div>
  </div>
  ...
  <div class="modal-content" style="max-width: 500px;">
    ...
    <div class="text-center">
      ...
      <p class="text-gray-600 dark:text-gray-400 mb-6">
        Are you sure you want to delete this employee? This will also delete all associated documents. This action cannot be undone.
      </p>
      <div class="flex gap-3">
        <button onclick="closeDeleteModal()" class="flex-1 py-3 rounded-xl border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors font-semibold">
          Cancel
        </button>
        <button onclick="confirmDelete()" class="flex-1 py-3 rounded-xl bg-red-600 text-white hover:bg-red-700 transition-colors font-semibold">
...
function displayEmployees(data) {
  ...
  tbody.innerHTML = data.map(emp => {
    ...
    <tr>
      ...
      <td class="text-gray-600 dark:text-gray-400">${emp.phone_number}</td>
...
function clearFileNames() {
  const fileInputs = ['national_id', 'character_certificate', 'bank_proof', 'cv_resume', 'appointment_letter', 'photograph'];
