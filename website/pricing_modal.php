    ...
    <div class="bg-white border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-6 py-4">
            <div class="flex items-center space-x-4">
                <a href="home.php" class="inline-flex items-center text-gray-600 hover:text-gray-900 transition-colors group">
                    ...
                    <div class="lg:col-span-1">
                        <div class="sticky top-6 bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200 rounded-xl p-5 h-fit shadow-md">
                            ...
                            <div class="border-b-2 border-gray-300 pb-4 mb-4">
                                ...
                                <p class="text-lg font-bold text-gray-900" id="selectedDomainSummary"><?php echo $domain; ?></p>
