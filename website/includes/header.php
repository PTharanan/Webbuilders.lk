...
<div class="top-bar">
    <div class="contact-info-left">
        <span><i class="fas fa-phone"></i> +94769988123</span>
        <span>|</span>
        <span><i class="fas fa-envelope"></i> info@WEBbuilders.lk</span>
    </div>
...
<nav class="navbar">
    <div class="nav-container">
        <div class="logo">
            <a href="home.php"><img src="images/logo.png" alt="WebBuilders"></a>
        </div>
        ...
        <ul class="nav-links">
            <li><a href="home.php" class="alt-color">Home</a></li>
        ...
        <div class="contact-box">
            ...
            <span class="number">+9476998123</span>
        </div>
    </div>
</nav>

<div class="mobile-overlay" id="mobileOverlay">
    <div class="close-overlay" id="closeMenu"><i class="fas fa-times"></i></div>
    <ul class="mobile-links">
        <li><a href="home.php">Home</a></li>
        <li class="mobile-has-dropdown">
            <div class="mobile-nav-item">
                <a href="home.php#pages">Pages</a>
    ...
    <div class="mobile-contact-footer">
        <div class="mobile-phone-wrap">
            <div class="phone-ico-box">
                <i class="fas fa-phone-alt"></i>
            </div>
            <span class="phone-num">+94769988123</span>
        </div>
    </div>
</div>